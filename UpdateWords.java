...
public class UpdateWords extends JFrame {
	...
	public UpdateWords() {
		...
		btnFirst.setIcon(new ImageIcon(UpdateWords.class.getResource("/boostYourVoc/First record.png")));
		btnFirst.setBounds(12, 177, 49, 40);
		contentPane.add(btnFirst);
		
		JButton btnPrevious = new JButton("");
		btnPrevious.addActionListener(Model.previousRecordListener);
		btnPrevious.setIcon(new ImageIcon(UpdateWords.class.getResource("/boostYourVoc/Previous_record.png")));
		...
		btnNext.setIcon(new ImageIcon(UpdateWords.class.getResource("/boostYourVoc/Next_track.png")));
		...
		btnLast.setIcon(new ImageIcon(UpdateWords.class.getResource("/boostYourVoc/Last_Record.png")));
		...
		textFieldID.setBounds(104, 28, 67, 32);
